...
Server port for listenning incoming requests can be configured as environment variable (.env is provide)
...
- State of db should be consistent between different workers, for example:
  ...
  - Third `DELETE` request addressed to `localhost:4003/ap`i deletes created user
